...
class music_cog(commands.Cog):
    ...
    async def join(self, ctx):
        ...
        await ctx.send(f"Joined {voice_state.channel}")
    ...
    @commands.command(name="clean", help="Stops the music and clears the queue")
    ...
    @commands.command(name="remove", aliases=["re"], help="Removes last song added to queue")
